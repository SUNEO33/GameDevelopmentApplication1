...
void EnemyAka::Update(float delta_second)
{
...
eEnemyState EnemyAka::GetEnemyState() const
{
	return enemy_state;
}
...
void EnemyAka::Movement(float delta_second)
{
	// 移動量から移動方向を更新
	...
	default:
		velocity = 0.0f;
		now_direction_state = next_direction_state;
		next_direction_state = EnemyAka::NONE;
		break;
	}
...
/// </summary>
/// <param name="delta_second">1フレームあたりの時間</param>
void EnemyAka::AnimationControl(float delta_second)
{
	// 移動中のアニメーション
